...
addpath Yall1;
TrainPath = 'pedestrians\input\'; numTrain = 300;
VideoPath = 'pedestrians\input\'; videolength = 300;
nrow = 120; ncol = nrow * 180/120;% frame dimension
p = nrow*ncol;
...
%Background
srcFiles = dir(strcat(TrainPath,'*.jpg'));
...
%Foreground
srcFiles = dir(strcat(VideoPath,'*.jpg'));
if length(srcFiles) > videolength
    srcFiles(1:videolength) = srcFiles(301:300+videolength);
end
...
save('ReproCS_10Ped_300Ped.mat' , 'Fg', 'Bg' , 'I' , 'videolength');